...
<html>
	...
	<body>
		...
		<form  method="post" action="${pageContext.request.contextPath }//user/login" class="form center">
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main  center">
					...
					<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名"/></div>
